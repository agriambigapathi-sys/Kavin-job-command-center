...
import { Briefcase, ShieldCheck, Sparkles, CheckCircle2, Lock, ArrowRight, AlertCircle, RefreshCw } from 'lucide-react';
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8 space-y-3">
          ...
          <p className="text-sm text-slate-400 max-w-xs mx-auto">
            Personal & Secure Career Command Center with real-time Firestore synchronization.
          </p>
        </div>
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-2xl backdrop-blur-md space-y-6">
          ...
          {(error || localError) && (
            <div className="p-3.5 rounded-xl bg-rose-500/10 border border-rose-500/30 text-rose-300 text-xs flex items-start gap-2.5">
              ...
              <div className="flex-1">
                ...
                <p className="mt-0.5 text-slate-300">{error || localError}</p>
              </div>
              <button
                onClick={() => {
                  clearError();
          ...
          <div className="space-y-2.5 pt-4 border-t border-slate-800/80 text-[11px] text-slate-400">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Zero hardcoded mock states; live persistent document store.</span>
            </div>
          </div>
        </div>
